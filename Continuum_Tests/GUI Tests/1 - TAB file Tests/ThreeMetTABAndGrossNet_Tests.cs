...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Load one met TAB file
	thisInst.metList.isTimeSeries = false;
	thisInst.ofdMets.FileName = testingFolder +"\\Met TAB files\\Firewheel\\Met_3.TAB";
	thisInst.ImportMetsTAB();
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Load one turbine
	string turbineFile = testingFolder + "\\Turbine sites\\Firewheel\\Firewheel turbine sites.csv";
...
[TestMethod]
public void ThreeMetTABAndGrossNet_182()
{
	Stopwatch stopWatch = new Stopwatch();
	stopWatch.Start();
	...
	string fileName = saveFolder + "\\ThreeMetTABAndGrossNet_182";
...
[TestMethod]
public void ThreeMetTABAndGrossNet_237()
{
	Stopwatch stopWatch = new Stopwatch();
	stopWatch.Start();
	...
	string fileName = saveFolder + "\\ThreeMetTABAndGrossNet_237";
...
[TestMethod]
public void ThreeMetTABAndGrossNet_24()
{
	Stopwatch stopWatch = new Stopwatch();
	stopWatch.Start();
	...
	string fileName = saveFolder + "\\ThreeMetTABAndGrossNet_24";
...
[TestMethod]
public void ThreeMetTABAndGrossNet_276()
{
	Stopwatch stopWatch = new Stopwatch();
	stopWatch.Start();
	...
	string fileName = saveFolder + "\\ThreeMetTABAndGrossNet_276";
...
[TestMethod]
public void ThreeMetTABAndGrossNet_313()
{
	Stopwatch stopWatch = new Stopwatch();
	stopWatch.Start();
	...
	string fileName = saveFolder + "\\ThreeMetTABAndGrossNet_313";
...
[TestMethod]
public void ThreeMetTABAndGrossNet_394()
{
	Stopwatch stopWatch = new Stopwatch();
	stopWatch.Start();
	...
	string fileName = saveFolder + "\\ThreeMetTABAndGrossNet_394";
...
[TestMethod]
public void ThreeMetTABAndGrossNet_408()
{
	Stopwatch stopWatch = new Stopwatch();
	stopWatch.Start();
	...
	string fileName = saveFolder + "\\ThreeMetTABAndGrossNet_408";
...
[TestMethod]
public void ThreeMetTABAndGrossNet_99()
{
	Stopwatch stopWatch = new Stopwatch();
	stopWatch.Start();
	...
	string fileName = saveFolder + "\\ThreeMetTABAndGrossNet_99";
