...
[TestMethod]
public void DelThreeMetTS_LT_12()
{
...
string fileName = saveFolder + "\\ThreeMetRawTS_LTGrossNet_3547.cfm";
...
[TestMethod]
public void DelThreeMetTS_LT_8()
{
	Stopwatch stopWatch = new Stopwatch();
	stopWatch.Start();
	...
	Continuum thisInst = new Continuum("");
	thisInst.isTest = true;
string fileName = saveFolder + "\\ThreeMetRawTS_LTGrossNet_459.cfm";
