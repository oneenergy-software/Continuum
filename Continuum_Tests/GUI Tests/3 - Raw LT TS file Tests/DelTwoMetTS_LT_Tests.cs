...
string fileName = saveFolder + "\\TwoMetRawTS_LTGrossNet_3281.cfm";
...
public void DelTwoMetTS_LT_7()
{
	...
	Continuum thisInst = new Continuum("");
	thisInst.isTest = true;
string fileName = saveFolder + "\\TwoMetRawTS_LTGrossNet_3908.cfm";
