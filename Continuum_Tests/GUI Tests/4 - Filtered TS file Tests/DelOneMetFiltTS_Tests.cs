...
string fileName = saveFolder + "\\OneMetFiltTS_GrossNet_400.cfm";
...
public void DelOneMetFiltTS_6()
{
	...
	Continuum thisInst = new Continuum("");
	thisInst.isTest = true;
string fileName = saveFolder + "\\OneMetFiltTS_GrossNet_451.cfm";
