...
[TestMethod]
public void DelTwoMetFiltTS_12()
{
...
string fileName = saveFolder + "\\TwoMetFiltTS_GrossNet_10.cfm";
...
public void DelTwoMetFiltTS_5()
{
	...
	Continuum thisInst = new Continuum("");
	thisInst.isTest = true;
string fileName = saveFolder + "\\TwoMetFiltTS_GrossNet_556.cfm";
