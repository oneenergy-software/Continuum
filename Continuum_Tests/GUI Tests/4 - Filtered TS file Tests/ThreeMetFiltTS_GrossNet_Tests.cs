...
{
   [TestClass]
   public class ThreeMetFiltTS_GrossNet
   {
      ...
      public ThreeMetFiltTS_GrossNet()
      {
...
[TestMethod]
public void ThreeMetFiltTS_GrossNet_311()
{
	...
	string fileName = saveFolder + "\\ThreeMetFiltTS_GrossNet_311";
...
[TestMethod]
public void ThreeMetFiltTS_GrossNet_642()
{
	Stopwatch stopWatch = new Stopwatch();
	stopWatch.Start();
	...
	string fileName = saveFolder + "\\ThreeMetFiltTS_GrossNet_642";
