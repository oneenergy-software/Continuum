...
{
   [TestClass]
   public class TwoMetFiltTS_GrossNet
   {
...
[TestMethod]
public void TwoMetFiltTS_GrossNet_198()
{
	...
	string fileName = saveFolder + "\\TwoMetFiltTS_GrossNet_198";
...
[TestMethod]
public void TwoMetFiltTS_GrossNet_631()
{
	Stopwatch stopWatch = new Stopwatch();
	stopWatch.Start();
	...
	string fileName = saveFolder + "\\TwoMetFiltTS_GrossNet_631";
