...
{
   [TestClass]
   public class DelOneMetFiltTS_LT
   {
...
[TestMethod]
public void DelOneMetFiltTS_LT_10()
{
...
string fileName = saveFolder + "\\OneMetFiltTS_LTGrossNet_1217.cfm";
...
[TestMethod]
public void DelOneMetFiltTS_LT_23()
{
	Stopwatch stopWatch = new Stopwatch();
	stopWatch.Start();
