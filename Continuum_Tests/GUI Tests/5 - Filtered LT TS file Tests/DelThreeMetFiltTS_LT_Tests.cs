...
{
   [TestClass]
   public class DelThreeMetFiltTS_LT
   {
...
[TestMethod]
public void DelThreeMetFiltTS_LT_1()
{
...
string fileName = saveFolder + "\\ThreeMetFiltTS_LTGrossNet_1235.cfm";
...
[TestMethod]
public void DelThreeMetFiltTS_LT_15()
{
	Stopwatch stopWatch = new Stopwatch();
	stopWatch.Start();
