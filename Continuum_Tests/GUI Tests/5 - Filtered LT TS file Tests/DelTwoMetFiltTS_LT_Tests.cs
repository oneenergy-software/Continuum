...
{
   [TestClass]
   public class DelTwoMetFiltTS_LT
   {
...
[TestMethod]
public void DelTwoMetFiltTS_LT_24()
{
...
string fileName = saveFolder + "\\TwoMetFiltTS_LTGrossNet_384.cfm";
...
[TestMethod]
public void DelTwoMetFiltTS_LT_8()
{
	Stopwatch stopWatch = new Stopwatch();
	stopWatch.Start();
