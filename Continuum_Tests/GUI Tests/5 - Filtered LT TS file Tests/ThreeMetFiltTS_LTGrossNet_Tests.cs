...
{
   [TestClass]
   public class ThreeMetFiltTS_LTGrossNet
   {
      ...
      public ThreeMetFiltTS_LTGrossNet()
      {
...
[TestMethod]
public void ThreeMetFiltTS_LTGrossNet_1()
{
	...
	string fileName = saveFolder + "\\ThreeMetFiltTS_LTGrossNet_1";
...
[TestMethod]
public void ThreeMetFiltTS_LTGrossNet_741()
{
	Stopwatch stopWatch = new Stopwatch();
	stopWatch.Start();
	...
	string fileName = saveFolder + "\\ThreeMetFiltTS_LTGrossNet_741";
