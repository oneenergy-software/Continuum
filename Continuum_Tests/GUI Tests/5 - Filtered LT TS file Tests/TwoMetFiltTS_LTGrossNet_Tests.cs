...
{
   [TestClass]
   public class TwoMetFiltTS_LTGrossNet
   {
      ...
      public TwoMetFiltTS_LTGrossNet()
      {
...
[TestMethod]
public void TwoMetFiltTS_LTGrossNet_384()
{
	...
	string fileName = saveFolder + "\\TwoMetFiltTS_LTGrossNet_384";
...
[TestMethod]
public void TwoMetFiltTS_LTGrossNet_531()
{
	Stopwatch stopWatch = new Stopwatch();
	stopWatch.Start();
	...
	string fileName = saveFolder + "\\TwoMetFiltTS_LTGrossNet_531";
