...
namespace Continuum_Tests
{
    ...
    public class MetPairCollection_Tests
    {
        ...
        public void GetRMS_SectorErr_Test()
        {
            ...
            Model[] theseModels = thisInst.modelList.GetModels(thisInst, thisInst.metList.GetMetsUsed(), 4000, 10000, false, Met.TOD.All, Met.Season.All, thisInst.modeledHeight, false);
